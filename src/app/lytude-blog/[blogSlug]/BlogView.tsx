// app/lytude-blog/[blogSlug]/BlogView.tsx

import React from 'react';
import { VStack, HStack } from '@/components/stack-layout';
import DateUtil from '@/utils/dateUtil';
import AboutLytudeBlog from '../components/AboutLytudeBlog';
...
const BlogView: React.FC<BlogViewProps> = ({ blog }) => {
    if (!blog) return <p className='inner-content' style={{ padding: "100px 20px" }}>Nothing found</p>;
    ...
    return (
        <div className="max-w-3xl mx-auto p-4">
            ...
            <div className='inner-content' style={{ padding: "15px" }}>
                <div className='blog-view-content-excerpt-top' style={{ padding: "0 20px" }}>
                    <HStack style={{ padding: "10px 0px", margin: "0", flexWrap: "wrap", maxWidth: "100%", overflowX: "scroll" }} gap="5px">
                        {categories.map((item, index) => (
                            <Link key={`blog-view-content-excerpt-top-${index}`} href={`/lytude-blog/categories/${item._id}`} >
                    ...
                    <HStack gap="10px" style={{ padding: "0px 6px", paddingTop: "21px" }}>
                        ...
                        <VStack align="flex-start" gap="0px" style={{ padding: "0px" }}>
                            ...
                            <p style={{ padding: "0", margin: "0", fontSize: "0.75rem" }}>
                                {DateUtil.simpleDate(blog._createdDate)}
                            </p>
                        </VStack>
                    </HStack>
                )}
                ...
                <HStack align="flex-start" justify="flex-start" gap="20px" style={{ width: "100%", flexWrap: "wrap" }}>
                    <VStack className="blog-view-blog-content-content" style={{ width: "100%", flex: "1" }}>
                        <div className="blog-view-blog-content" dangerouslySetInnerHTML={{ __html: content }} />
                    ...
                    <VStack style={{ maxWidth: "300px" }}>
                        <div className='blog-view-content-excerpt-side' style={{ padding: "0 20px" }}>
                            <HStack style={{ padding: "10px 0px", margin: "0", flexWrap: "wrap", maxWidth: "100%", overflowX: "scroll" }} gap="5px">
                                {categories.map((item, index) => (
                                    <Link key={`blog-view-content-excerpt-side-${index}`} href={`/lytude-blog/categories/${item._id}`} >
                                        <Sticker label={item.name} />
                                    </Link>
                                ))}
                            </HStack>
            ...
            <style>{`
                .blog-view-blog-content p, .blog-view-blog-content b {
                    font-size: 1.25rem;
                }

                .blog-view-blog-content h1 {
                    font-size: 2.5rem;
                }

                .blog-view-blog-content h2, .blog-view-blog-content h3 {
                    font-size: 2rem;
                }

                .blog-view-blog-content-content {
                    min-width: 400px;
                }

                .blog-view-content-excerpt-top {
                    display: none;
                }
                ...
                @media only screen and (max-width: 700px) {
                    ...
                    .blog-view-content-excerpt-side {
                        display: none;
                    }
